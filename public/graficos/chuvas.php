...
function alertas($qtde, $volume, $cor, $ud, $estacao, $periodo, $local){
	...
	if ($volume > 0){
		...
		define('GUSER', 'seuemail@prefeitura.sc.gov.br');	// <-- Insira aqui o seu GMail
		...
		function smtpmailer($de, $de_nome, $assunto, $corpo) { 
			...
			$mail->Host = 'smtp.provedor.org.br';	// SMTP utilizado
			...
			$mail->Body = $corpo;
			$mail->AddAddress('destino@gmail.com'); //destinatário
			$mail->AddCC('defesacivil@prefeitura.sc.gov.br'); //destinatário cc
			if(!$mail->Send()) {
		...
		if (smtpmailer('dev@prefeitura.sc.gov.br', 'DTI - GAROPABA/SC', 'Alerta '.$cor.' - '.$local, $corpo)) {
	...
	<body>
		...
		<?php }else{ ?>
			...
			<table class="table-sm table1" >
				...
				<tbody>
					<tr>
						<td><a class="nav-link" style="font-size: 1.6rem; color: navy;" href="graficos.php?id=1a&h=24" target="_blank"> <img src="../img/24h.png" width="60px"</a></td>
						<td><a class="nav-link" style="font-size: 1.6rem; color: navy;" href="graficos.php?id=2a&h=24" target="_blank"> <img src="../img/24h.png" width="60px"</a></td>
						<td><a class="nav-link" style="font-size: 1.6rem; color: navy;" href="graficos.php?id=3a&h=24" target="_blank"> <img src="../img/24h.png" width="60px"</a></td>
					</tr>
					<tr> 	
						<td><a class="nav-link" style="font-size: 1.6rem; color: navy;" href="graficos.php?id=1b&h=36" target="_blank"> <img src="../img/36h.png" width="60px"</a></td>
						<td><a class="nav-link" style="font-size: 1.6rem; color: navy;" href="graficos.php?id=2b&h=36" target="_blank"> <img src="../img/36h.png" width="60px"</a></td>
						<td><a class="nav-link" style="font-size: 1.6rem; color: navy;" href="graficos.php?id=3b&h=36" target="_blank"> <img src="../img/36h.png" width="60px"</a></td>		
					</tr> 
					<tr>	
						<td><a class="nav-link" style="font-size: 1.6rem; color: navy;" href="graficos.php?id=1c&h=48" target="_blank"> <img src="../img/48h.png" width="60px"</a></td>
						<td><a class="nav-link" style="font-size: 1.6rem; color: navy;" href="graficos.php?id=2c&h=48" target="_blank"> <img src="../img/48h.png" width="60px"</a></td>
						<td><a class="nav-link" style="font-size: 1.6rem; color: navy;" href="graficos.php?id=3c&h=48" target="_blank"> <img src="../img/48h.png" width="60px"</a></td>
					</tr> 
					<tr>	
						<td><a class="nav-link" style="font-size: 1.6rem; color: navy;" href="graficos.php?id=1d&h=54" target="_blank"> <img src="../img/54h.png" width="60px"</a></td>
						<td><a class="nav-link" style="font-size: 1.6rem; color: navy;" href="graficos.php?id=2d&h=54" target="_blank"> <img src="../img/54h.png" width="60px"</a></td>	
						<td><a class="nav-link" style="font-size: 1.6rem; color: navy;" href="graficos.php?id=3d&h=54" target="_blank"> <img src="../img/54h.png" width="60px"</a></td>
					</tr>
			</table>
		...
		<footer>
			<div id="footer" style="padding-left:37%; text-align: center;"><a href="https://garopaba.atende.net/" target="_blank"><p>DTI - GAROPABA - JANEIRO/2023</p></a></div>
		</footer>
		<?php } 
		$link->close();
		?>
